...
# ---------------------------------------------------------
# Neuesten Rustdesk Installer herunterladen
# ---------------------------------------------------------
...
Write-Host "Download abgeschlossen: $destFile"

# Variable $destFile enthaelt den Pfad zur EXE fuer dein weiteres Script
